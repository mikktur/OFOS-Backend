...
public class JwtUtil {
    ...
    private final SecretKey SECRET_KEY = Keys.secretKeyFor(SignatureAlgorithm.HS256); //  chage this to use dotenv!
    ...
    public Boolean validateToken(String token, String username) {
        ...
        return (extractedUsername.equals(username.toLowerCase()) && !isTokenExpired(token));
    }
}